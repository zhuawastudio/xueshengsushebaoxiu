<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
           <el-form-item v-if="flag=='weixiuyuan'"  label='工号' prop="weixiuyuanUuidNumber">
               <el-input v-model="ruleForm.weixiuyuanUuidNumber"  placeholder='工号' clearable></el-input>
           </el-form-item>
         </el-col>
...
// 注册表 学生 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         if((!this.ruleForm.weixiuyuanUuidNumber)&& 'weixiuyuan'==this.flag){
