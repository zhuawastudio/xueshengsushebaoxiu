            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='sushe' ">
                    <el-form-item class="input" v-if="type!='info'"  label="宿舍号" prop="susheUuidNumber">
                        <el-input v-model="susheForm.susheUuidNumber"
                                  placeholder="宿舍号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='sushe' ">
                    <el-form-item class="input" v-if="type!='info'"  label="最大居住人数" prop="juzhuNumber">
                        <el-input v-model="susheForm.juzhuNumber"
                                  placeholder="最大居住人数" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`susheRen/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.susheRenCrossAddOrUpdateFlag = false;
                                        this.parent.search();
