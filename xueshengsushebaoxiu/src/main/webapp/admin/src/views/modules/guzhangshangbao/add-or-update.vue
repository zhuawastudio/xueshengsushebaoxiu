<template>
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='weixiuyuan' && sessionTable !='xuesheng'">
                    <el-form-item class="select" v-if="type!='info'"  label="维修人员" prop="weixiuyuanId">
                        <el-select v-model="ruleForm.weixiuyuanId" :disabled="ro.weixiuyuanId" filterable placeholder="请选择维修人员" @change="weixiuyuanChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='weixiuyuan' && !(sessionTable=='xuesheng' && type!='info') ">
                    <el-form-item class="input" v-if="type!='info'"  label="工号" prop="weixiuyuanUuidNumber">
                        <el-input v-model="weixiuyuanForm.weixiuyuanUuidNumber"
                                  placeholder="工号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="工号" prop="weixiuyuanUuidNumber">
                            <el-input v-model="ruleForm.weixiuyuanUuidNumber"
                ...
                <el-col :span="12"  v-if="sessionTable !='weixiuyuan' && !(sessionTable=='xuesheng' && type!='info')  ">
                    <el-form-item class="input" v-if="type!='info'"  label="工作年限" prop="weixiuyuanNianxian">
                        <el-input v-model="weixiuyuanForm.weixiuyuanNianxian"
                                  placeholder="工作年限" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="工作年限" prop="weixiuyuanNianxian">
                            <el-input v-model="ruleForm.weixiuyuanNianxian"
                                      placeholder="工作年限" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='weixiuyuan' && !(sessionTable=='xuesheng' && type!='info')  ">
                    <el-form-item class="input" v-if="type!='info'"  label="联系方式" prop="weixiuyuanPhone">
                        <el-input v-model="weixiuyuanForm.weixiuyuanPhone"
                                  placeholder="联系方式" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="联系方式" prop="weixiuyuanPhone">
                ...
                <el-col :span="12" v-if="sessionTable !='weixiuyuan' && !(sessionTable=='xuesheng' && type!='info')  ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.weixiuyuanPhoto" label="照片" prop="weixiuyuanPhoto">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.weixiuyuanPhoto" label="照片" prop="weixiuyuanPhoto">
            ...
            <input id="weixiuyuanId" name="weixiuyuanId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="上报编号" prop="guzhangshangbaoUuidNumber">
                       <el-input v-model="ruleForm.guzhangshangbaoUuidNumber"
                                 placeholder="上报编号" clearable  :readonly="ro.guzhangshangbaoUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="上报编号" prop="guzhangshangbaoUuidNumber">
                           <el-input v-model="ruleForm.guzhangshangbaoUuidNumber"
                                     placeholder="上报编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="物品分类" prop="wupinTypes">
                        <el-select v-model="ruleForm.wupinTypes" :disabled="ro.wupinTypes" placeholder="请选择物品分类">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="物品分类" prop="wupinValue">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="故障分类" prop="guzhangshangbaoTypes">
                        <el-select v-model="ruleForm.guzhangshangbaoTypes" :disabled="ro.guzhangshangbaoTypes" placeholder="请选择故障分类">
                            <el-option
                                v-for="(item,index) in guzhangshangbaoTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="故障分类" prop="guzhangshangbaoValue">
                        <el-input v-model="ruleForm.guzhangshangbaoValue"
                            placeholder="故障分类" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="报修位置" prop="guzhangshangbaoAddress">
                       <el-input v-model="ruleForm.guzhangshangbaoAddress"
                                 placeholder="报修位置" clearable  :readonly="ro.guzhangshangbaoAddress"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="报修位置" prop="guzhangshangbaoAddress">
                           <el-input v-model="ruleForm.guzhangshangbaoAddress"
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    xueshengId: false,
                    weixiuyuanId: false,
                    guzhangshangbaoUuidNumber: false,
                    wupinTypes: false,
                ...
                ruleForm: {
                    xueshengId: '',
                    weixiuyuanId: '',
                    guzhangshangbaoUuidNumber: new Date().getTime(),
                    wupinTypes: '',
                    guzhangshangbaoTypes: '',
                ...
                rules: {
                   ...
                   guzhangshangbaoUuidNumber: [
                              { required: true, message: '上报编号不能为空', trigger: 'blur' },
                          ],
                   wupinTypes: [
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=guzhangshangbao_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.guzhangshangbaoTypesOptions = data.data.list;
                    }
                });
                this.$http({
